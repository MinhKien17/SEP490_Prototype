    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      <header className="bg-[#1e3a8a] text-white px-8 h-16 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-indigo-500 text-white rounded-md text-xs flex items-center justify-center font-bold">EP</div>
          <span className="font-bold text-lg tracking-wider">My Projects</span>
        </div>
